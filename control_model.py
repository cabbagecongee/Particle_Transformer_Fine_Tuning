...
NAME = "control_model_10%_new_dataloader_weights"
BATCH_SIZE = 256
LR = 1e-4
EPOCHS = 10
...
length_train_rank = sum(parquet_num_rows_allowed(fp, ALLOWED_LABELS) for fp in train_files_rank)
length_val_rank   = sum(parquet_num_rows_allowed(fp, ALLOWED_LABELS) for fp in val_files_rank)
